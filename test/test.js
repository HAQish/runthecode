...
describe('Server', () => {
  ...
  describe('Auth Routes', () => {
    const testUser = { username: 'testmocha@gmail.com', password: 'testpw', nickname: 'testmocha' };
    const testUser2 = { username: 'testmocha2@gmail.com', password: 'testpw', nickname: 'testmocha2' };
    const emailTaken = { message: ['Email already taken'] };
    const wrongPassword = { message: ['Incorrect password'] };
    // signup tests
