...
const docs = fs.readFile('./database/seed/initialChallenges.json', 'utf8', (err, data) => {
  console.log(data);
  ...
  items.insert(JSON.parse(data), (err, docs) => {
    items.count((err, count) => {
      ...
      const courseDocs = fs.readFile('./database/seed/levelOneChallenges.json', 'utf8', (err, data) => {
        ...
        collection.insert(JSON.parse(data), (err, docs) => {
          collection.count((err, count) => {
            ...
            const challengeDocs = fs.readFile('./database/seed/allChallenges.json', 'utf8', (err, data) => {
